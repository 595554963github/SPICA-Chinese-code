...
namespace SPICA.WinForms.GUI
{
    public partial class SUIList : UserControl
    {
        ...
        [Category("外观"), Description("滚动条的正常颜色.")]
        ...
        [Category("外观"), Description("鼠标悬停时滚动条的颜色.")]
        ...
        [Category("外观"), Description("选定项目的背景颜色.")]
        ...
        [Category("行为学"), Description("每个列表项目的固定高度.")]
        ...
        [Category("行为学"), Description("允许一次选择多个项目.")]
